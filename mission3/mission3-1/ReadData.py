...
def read1(path, length):
    ...
    for i in range(len(datas)/length):
        ...
        ave_r = math.sqrt((ave_x**2+ave_y**2+ave_z**2)/3.0)
        ...
        for j in seq:
            ...
            min_r = math.sqrt((min_x**2+min_y**2+min_z**2)/3.0)
            max_r = math.sqrt((max_x**2+max_y**2+max_z**2)/3.0)
            sqr_x = sqr_x + j[0]*j[0]
            sqr_y = sqr_y + j[1]*j[1]
            sqr_z = sqr_z + j[2]*j[2] 
        ...
        var_r = math.sqrt((var_x**2+var_y**2+var_z**2)/3.0)
